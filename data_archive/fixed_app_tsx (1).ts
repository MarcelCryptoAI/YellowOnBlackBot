  ...
  const [bybitConnections, setBybitConnections] = useState<BybitConnection[]>([
    {
      ...
      balance: {
        ...
        balanceHistory: [
          ...
          { time: '08:00', value: 298 },
          { time: '12:00', value: 305 },
          { time: '16:00', value: 303.54 }
        ]
      },
    ...
    setTimeout(() => {
      const newConnection: BybitConnection = {
        ...
        balance: {
          ...
          balanceHistory: [
            { time: '00:00', value: Math.random() * 1000 },
            { time: '04:00', value: Math.random() * 1000 },
            { time: '08:00', value: Math.random() * 1000 },
            { time: '12:00', value: Math.random() * 1000 },
            { time: '16:00', value: Math.random() * 1000 }
          ]
        },
            ...
            <div className="relative group">
              ...
              <div className="relative bg-gradient-to-br from-black to-gray-900 p-6 rounded-xl border border-gray-600/30 hover:border-yellow-400/40 transition-all duration-300 shadow-2xl shadow-black/50">
                <div className="flex items-center justify-between mb-6">
                  <h3 className="text-xl font-bold bg-gradient-to-r from-yellow-400 to-white bg-clip-text text-transparent drop-shadow-lg">
                    🟡 BYBIT CONNECTIONS ({bybitConnections.length})
                  </h3>
                  <div className="text-sm text-gray-400">
                    Total Balance: ${bybitConnections.reduce((sum, conn) => sum + conn.balance.total, 0).toFixed(2)}
                  </div>
                </div>
                    ...
                    <div key={connection.id} className="flex items-center justify-between p-4 bg-gradient-to-r from-gray-900 to-black rounded-lg border border-gray-700/40 hover:border-yellow-400/30 transition-all group/item">
                        ...
                        <div className="flex items-center space-x-3">
                          ...
                          <div>
                            ...
                            <div className="flex items-center space-x-2 text-xs text-gray-400">
                              ...
                              <span>•</span>
                              <span>{connection.testnet ? 'Testnet' : 'Mainnet'}</span>
                              <span>•</span>
                      ...
                      <div className="flex items-center space-x-6">
                        <div className="text-right">
                          <div className="text-white font-bold">${connection.balance.total.toFixed(2)}</div>
                          <div className="text-xs text-gray-400">Available: ${connection.balance.available.toFixed(2)}</div>
                        </div>
                        
                        {connection.status === 'Active' && (
                          <div className="w-16 h-8 relative">
                            <svg width="64" height="32" viewBox="0 0 64 32" className="text-green-400">
                              <polyline
                                fill="none"
                                stroke="currentColor"
                                strokeWidth="1.5"
                        ...
                        <div className="flex items-center space-x-2">
                          ...
                          <div className="relative group/menu">
                            ...
                            <div className="absolute right-0 top-10 bg-gray-900 border border-gray-600 rounded-lg shadow-xl opacity-0 invisible group-hover/menu:opacity-100 group-hover/menu:visible transition-all z-20">
                              <button
                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      <input
                        ...
                        placeholder="e.g., Main Trading Account, Scalping Bot..."
                    ...
                    <div>
                      <label className="block text-gray-300 text-sm font-medium mb-3">Markets to Connect</label>
                      <div className="space-y-3">
                        <div className="flex items-center space-x-3">
                          <input
                            type="checkbox"
                          ...
                          />
                          <label htmlFor="spot" className="text-gray-300 text-sm flex items-center space-x-2">
                            <span className="px-2 py-1 text-xs bg-blue-500/20 text-blue-300 border border-blue-500/40 rounded">Spot</span>
                        ...
                        <div className="flex items-center space-x-3">
                          <input
                            ...
                            className="w-4 h-4 text-purple-400 bg-gray-900 border-gray-600 rounded focus:ring-purple-400"
                          />
                          <label htmlFor="usdtPerpetual" className="text-gray-300 text-sm flex items-center space-x-2">
                            <span className="px-2 py-1 text-xs bg-purple-500/20 text-purple-300 border border-purple-500/40 rounded">USDT⊥</span>
                        ...
                        <div className="flex items-center space-x-3">
                          <input
                            ...
                            className="w-4 h-4 text-orange-400 bg-gray-900 border-gray-600 rounded focus:ring-orange-400"
                          />
                          <label htmlFor="inverseUsd" className="text-gray-300 text-sm flex items-center space-x-2">
                            <span className="px-2 py-1 text-xs bg-orange-500/20 text-orange-300 border border-orange-500/40 rounded">USD⊥</span>
                    ...
                    <div className="flex items-center space-x-3">
                      ...
                      />
                      <label htmlFor="testnet" className="text-gray-300 text-sm">Use Testnet (Recommended for testing)</label>
                    </div>
                    
                    <button
                      onClick={testBybitConnection}
                      disabled={isTesting.bybit}
                      className="w-full bg-gradient-to-r from-yellow-400 to-yellow-500 hover:from-yellow-300 hover:to-yellow-400 disabled:from-gray-600 disabled:to-gray-700 text-black font-bold py-3 px-4 rounded-lg transition-all duration-300 shadow-lg"
                    >
              ...
              <div className="p-6 space-y-6">
                ...
                <div>
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    <span className="text-white font-medium">Bybit {selectedConnection.testnet ? 'Testnet' : 'Spot'}</span>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="flex items-center space-x-2">
                    <div className={`w-2 h-2 rounded-full ${
                      selectedConnection.status === 'Active' ? 'bg-green-400' : 'bg-red-400'
                    }`} />
                    <span className={selectedConnection.status === 'Active' ? 'text-green-300' : 'text-red-300'}>
                ...
                <div>
                  ...
                  <div className="bg-gray-900 rounded-lg p-4 border border-gray-700/40">
                    <div className="text-2xl font-bold text-white mb-2">
                      ${selectedConnection.balance.total.toFixed(2)}
                    </div>
                    <div className="text-sm text-gray-400 mb-4">
                      Available: ${selectedConnection.balance.available.toFixed(2)}
                    </div>
