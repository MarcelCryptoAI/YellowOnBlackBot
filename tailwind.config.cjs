...
module.exports = {
  ...
  theme: {
    extend: {
      ...
      fontSize: {
        'xs': ['0.25rem', { lineHeight: '0.375rem' }],
        'sm': ['0.3125rem', { lineHeight: '0.4375rem' }],
        'base': ['0.375rem', { lineHeight: '0.5rem' }],
        'lg': ['0.4375rem', { lineHeight: '0.625rem' }],
        'xl': ['0.5rem', { lineHeight: '0.75rem' }],
        '2xl': ['0.625rem', { lineHeight: '0.875rem' }],
        '3xl': ['0.75rem', { lineHeight: '1rem' }],
        '4xl': ['0.875rem', { lineHeight: '1.125rem' }],
        '5xl': ['1rem', { lineHeight: '1.25rem' }],
        '6xl': ['1.25rem', { lineHeight: '1.5rem' }],
        '7xl': ['1.5rem', { lineHeight: '1.75rem' }],
        '8xl': ['2rem', { lineHeight: '2.25rem' }],
        '9xl': ['2.5rem', { lineHeight: '3rem' }],
      },
      fontFamily: {
